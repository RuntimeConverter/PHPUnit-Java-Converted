...
public class PHP_Token_DOLLAR_OPEN_CURLY_BRACES extends PHP_Token {

    public PHP_Token_DOLLAR_OPEN_CURLY_BRACES(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DOLLAR_OPEN_CURLY_BRACES.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DOLLAR_OPEN_CURLY_BRACES";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DOLLAR_OPEN_CURLY_BRACES")
                    .setLookup(
