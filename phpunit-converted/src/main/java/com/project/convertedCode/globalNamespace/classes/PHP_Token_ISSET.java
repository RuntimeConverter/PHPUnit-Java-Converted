...
public class PHP_Token_ISSET extends PHP_Token {

    public PHP_Token_ISSET(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ISSET.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ISSET";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ISSET")
                    .setLookup(PHP_Token_ISSET.class, java.lang.invoke.MethodHandles.lookup())
