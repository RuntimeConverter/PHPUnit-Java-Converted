...
public class assertNotContainsOnly extends FunctionBaseRegular {

    public static assertNotContainsOnly f = new assertNotContainsOnly();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertNotContainsOnly(
                env,
