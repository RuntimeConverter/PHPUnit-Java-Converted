...
public class PHP_Token_DIR extends PHP_Token {

    public PHP_Token_DIR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DIR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DIR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DIR")
                    .setLookup(PHP_Token_DIR.class, java.lang.invoke.MethodHandles.lookup())
