...
public class Deprecated extends Error {
    ...
    public static final Object CONST_class = "PHPUnit\\Framework\\Error\\Deprecated";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Framework\\Error\\Deprecated")
                    .setLookup(Deprecated.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties("serializableTrace")
                    .setFilename("vendor/phpunit/phpunit/src/Framework/Error/Deprecated.php")
