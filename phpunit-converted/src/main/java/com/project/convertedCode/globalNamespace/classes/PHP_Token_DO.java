...
public class PHP_Token_DO extends PHP_Token {

    public PHP_Token_DO(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DO.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DO";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DO")
                    .setLookup(PHP_Token_DO.class, java.lang.invoke.MethodHandles.lookup())
