...
public class PHP_Token_ENDSWITCH extends PHP_Token {

    public PHP_Token_ENDSWITCH(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ENDSWITCH.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ENDSWITCH";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ENDSWITCH")
                    .setLookup(PHP_Token_ENDSWITCH.class, java.lang.invoke.MethodHandles.lookup())
