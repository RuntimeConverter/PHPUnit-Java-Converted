...
public class assertFileNotIsWritable extends FunctionBaseRegular {

    public static assertFileNotIsWritable f = new assertFileNotIsWritable();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertFileNotIsWritable(
                env,
