...
public class PHP_Token_COMMA extends PHP_Token {

    public PHP_Token_COMMA(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_COMMA.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_COMMA";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_COMMA")
                    .setLookup(PHP_Token_COMMA.class, java.lang.invoke.MethodHandles.lookup())
