...
public class PHP_Token_SL extends PHP_Token {

    public PHP_Token_SL(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_SL.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_SL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_SL")
                    .setLookup(PHP_Token_SL.class, java.lang.invoke.MethodHandles.lookup())
