...
public class PHP_Token_ELSEIF extends PHP_Token {

    public PHP_Token_ELSEIF(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ELSEIF.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ELSEIF";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ELSEIF")
                    .setLookup(PHP_Token_ELSEIF.class, java.lang.invoke.MethodHandles.lookup())
