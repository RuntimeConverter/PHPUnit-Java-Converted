...
public class PHP_Token_COMMENT extends PHP_Token {

    public PHP_Token_COMMENT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_COMMENT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_COMMENT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_COMMENT")
                    .setLookup(PHP_Token_COMMENT.class, java.lang.invoke.MethodHandles.lookup())
