...
public class PHP_Token_CLASS_C extends PHP_Token {

    public PHP_Token_CLASS_C(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CLASS_C.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CLASS_C";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CLASS_C")
                    .setLookup(PHP_Token_CLASS_C.class, java.lang.invoke.MethodHandles.lookup())
