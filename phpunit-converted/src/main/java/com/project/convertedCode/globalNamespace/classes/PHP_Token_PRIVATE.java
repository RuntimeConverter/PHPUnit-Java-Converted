...
public class PHP_Token_PRIVATE extends PHP_Token {

    public PHP_Token_PRIVATE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_PRIVATE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_PRIVATE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_PRIVATE")
                    .setLookup(PHP_Token_PRIVATE.class, java.lang.invoke.MethodHandles.lookup())
