...
public class PHP_Token_PROTECTED extends PHP_Token {

    public PHP_Token_PROTECTED(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_PROTECTED.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_PROTECTED";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_PROTECTED")
                    .setLookup(PHP_Token_PROTECTED.class, java.lang.invoke.MethodHandles.lookup())
