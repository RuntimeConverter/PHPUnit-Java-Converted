...
public class PHP_Token_EXTENDS extends PHP_Token {

    public PHP_Token_EXTENDS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_EXTENDS.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_EXTENDS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_EXTENDS")
                    .setLookup(PHP_Token_EXTENDS.class, java.lang.invoke.MethodHandles.lookup())
