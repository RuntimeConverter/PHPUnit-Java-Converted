...
public class Notice extends Error {

    public Notice(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Notice.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHPUnit\\Framework\\Error\\Notice";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Framework\\Error\\Notice")
                    .setLookup(Notice.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties("serializableTrace")
                    .setFilename("vendor/phpunit/phpunit/src/Framework/Error/Notice.php")
