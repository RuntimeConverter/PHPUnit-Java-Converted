...
public class PHP_Token_POW_EQUAL extends PHP_Token {

    public PHP_Token_POW_EQUAL(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_POW_EQUAL.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_POW_EQUAL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_POW_EQUAL")
                    .setLookup(PHP_Token_POW_EQUAL.class, java.lang.invoke.MethodHandles.lookup())
