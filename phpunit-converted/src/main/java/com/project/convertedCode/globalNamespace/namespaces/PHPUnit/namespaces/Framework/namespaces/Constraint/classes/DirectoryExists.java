...
public class DirectoryExists extends Constraint {
    ...
    protected Object matches(RuntimeEnv env, Object... args) {
        ...
        return ZVal.assign(NamespaceGlobal.is_dir.env(env).call(other).value());
    }
    ...
    protected Object failureDescription(RuntimeEnv env, Object... args) {
        Object other = assignParameter(args, 0, null);
        return ZVal.assign(
                NamespaceGlobal.sprintf.env(env).call("directory \"%s\" exists", other).value());
    }
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    ...
                    .setLookup(DirectoryExists.class, java.lang.invoke.MethodHandles.lookup())
