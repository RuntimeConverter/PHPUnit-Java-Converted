...
public class assertAttributeNotEmpty extends FunctionBaseRegular {

    public static assertAttributeNotEmpty f = new assertAttributeNotEmpty();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertAttributeNotEmpty(
                env,
