...
public class PHP_Token_LIST extends PHP_Token {

    public PHP_Token_LIST(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_LIST.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_LIST";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_LIST")
                    .setLookup(PHP_Token_LIST.class, java.lang.invoke.MethodHandles.lookup())
