...
public class PHP_Token_ABSTRACT extends PHP_Token {

    public PHP_Token_ABSTRACT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ABSTRACT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ABSTRACT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ABSTRACT")
                    .setLookup(PHP_Token_ABSTRACT.class, java.lang.invoke.MethodHandles.lookup())
