...
public class PHP_Token_MINUS extends PHP_Token {

    public PHP_Token_MINUS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_MINUS.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_MINUS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_MINUS")
                    .setLookup(PHP_Token_MINUS.class, java.lang.invoke.MethodHandles.lookup())
