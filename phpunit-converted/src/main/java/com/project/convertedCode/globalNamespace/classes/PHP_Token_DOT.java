...
public class PHP_Token_DOT extends PHP_Token {

    public PHP_Token_DOT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DOT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DOT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DOT")
                    .setLookup(PHP_Token_DOT.class, java.lang.invoke.MethodHandles.lookup())
