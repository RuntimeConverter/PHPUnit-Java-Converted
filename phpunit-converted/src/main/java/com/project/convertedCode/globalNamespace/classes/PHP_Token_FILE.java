...
public class PHP_Token_FILE extends PHP_Token {

    public PHP_Token_FILE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_FILE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_FILE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_FILE")
                    .setLookup(PHP_Token_FILE.class, java.lang.invoke.MethodHandles.lookup())
