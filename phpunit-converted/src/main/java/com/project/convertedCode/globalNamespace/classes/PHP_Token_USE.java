...
public class PHP_Token_USE extends PHP_Token {

    public PHP_Token_USE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_USE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_USE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_USE")
                    .setLookup(PHP_Token_USE.class, java.lang.invoke.MethodHandles.lookup())
