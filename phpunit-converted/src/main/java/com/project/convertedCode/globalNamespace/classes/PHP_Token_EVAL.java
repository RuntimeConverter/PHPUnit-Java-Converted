...
public class PHP_Token_EVAL extends PHP_Token {

    public PHP_Token_EVAL(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_EVAL.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_EVAL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_EVAL")
                    .setLookup(PHP_Token_EVAL.class, java.lang.invoke.MethodHandles.lookup())
