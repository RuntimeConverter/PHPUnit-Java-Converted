...
public class PHP_Token_INLINE_HTML extends PHP_Token {

    public PHP_Token_INLINE_HTML(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_INLINE_HTML.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_INLINE_HTML";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_INLINE_HTML")
                    .setLookup(PHP_Token_INLINE_HTML.class, java.lang.invoke.MethodHandles.lookup())
