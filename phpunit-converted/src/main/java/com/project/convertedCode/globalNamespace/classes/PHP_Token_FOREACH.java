...
public class PHP_Token_FOREACH extends PHP_Token {

    public PHP_Token_FOREACH(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_FOREACH.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_FOREACH";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_FOREACH")
                    .setLookup(PHP_Token_FOREACH.class, java.lang.invoke.MethodHandles.lookup())
