...
public class PHP_Token_COALESCE extends PHP_Token {

    public PHP_Token_COALESCE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_COALESCE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_COALESCE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_COALESCE")
                    .setLookup(PHP_Token_COALESCE.class, java.lang.invoke.MethodHandles.lookup())
