...
public class PHP_Token_SR extends PHP_Token {

    public PHP_Token_SR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_SR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_SR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_SR")
                    .setLookup(PHP_Token_SR.class, java.lang.invoke.MethodHandles.lookup())
