...
public class PHP_Token_ECHO extends PHP_Token {

    public PHP_Token_ECHO(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ECHO.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ECHO";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ECHO")
                    .setLookup(PHP_Token_ECHO.class, java.lang.invoke.MethodHandles.lookup())
