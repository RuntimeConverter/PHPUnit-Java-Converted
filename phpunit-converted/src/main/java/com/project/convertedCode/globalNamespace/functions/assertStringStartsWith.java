...
public class assertStringStartsWith extends FunctionBaseRegular {

    public static assertStringStartsWith f = new assertStringStartsWith();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertStringStartsWith(
                env,
