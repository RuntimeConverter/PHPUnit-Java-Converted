...
public class PHP_Token_INT_CAST extends PHP_Token {

    public PHP_Token_INT_CAST(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_INT_CAST.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_INT_CAST";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_INT_CAST")
                    .setLookup(PHP_Token_INT_CAST.class, java.lang.invoke.MethodHandles.lookup())
