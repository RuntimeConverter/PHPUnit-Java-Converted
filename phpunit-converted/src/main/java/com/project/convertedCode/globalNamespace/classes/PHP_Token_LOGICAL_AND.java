...
public class PHP_Token_LOGICAL_AND extends PHP_Token {

    public PHP_Token_LOGICAL_AND(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_LOGICAL_AND.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_LOGICAL_AND";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_LOGICAL_AND")
                    .setLookup(PHP_Token_LOGICAL_AND.class, java.lang.invoke.MethodHandles.lookup())
