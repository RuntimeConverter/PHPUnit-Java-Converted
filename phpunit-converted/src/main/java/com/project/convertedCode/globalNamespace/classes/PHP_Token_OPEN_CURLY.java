...
public class PHP_Token_OPEN_CURLY extends PHP_Token {

    public PHP_Token_OPEN_CURLY(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_OPEN_CURLY.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_OPEN_CURLY";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_OPEN_CURLY")
                    .setLookup(PHP_Token_OPEN_CURLY.class, java.lang.invoke.MethodHandles.lookup())
