...
public class A extends RuntimeClassBase {
    ...
    public static final Object CONST_class = "DeepCopy\\f006\\A";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("DeepCopy\\f006\\A")
                    .setLookup(A.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties("aProp", "cloned")
                    .setFilename("vendor/myclabs/deep-copy/fixtures/f006/A.php")
                    .get();
