...
public class PHP_Token_YIELD_FROM extends PHP_Token {

    public PHP_Token_YIELD_FROM(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_YIELD_FROM.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_YIELD_FROM";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_YIELD_FROM")
                    .setLookup(PHP_Token_YIELD_FROM.class, java.lang.invoke.MethodHandles.lookup())
