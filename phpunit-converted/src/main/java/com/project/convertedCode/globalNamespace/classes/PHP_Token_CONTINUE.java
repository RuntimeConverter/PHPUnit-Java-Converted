...
public class PHP_Token_CONTINUE extends PHP_Token {

    public PHP_Token_CONTINUE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CONTINUE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CONTINUE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CONTINUE")
                    .setLookup(PHP_Token_CONTINUE.class, java.lang.invoke.MethodHandles.lookup())
