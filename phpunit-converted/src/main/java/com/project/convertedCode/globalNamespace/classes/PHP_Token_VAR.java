...
public class PHP_Token_VAR extends PHP_Token {

    public PHP_Token_VAR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_VAR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_VAR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_VAR")
                    .setLookup(PHP_Token_VAR.class, java.lang.invoke.MethodHandles.lookup())
