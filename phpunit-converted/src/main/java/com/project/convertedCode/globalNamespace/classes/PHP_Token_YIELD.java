...
public class PHP_Token_YIELD extends PHP_Token {

    public PHP_Token_YIELD(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_YIELD.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_YIELD";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_YIELD")
                    .setLookup(PHP_Token_YIELD.class, java.lang.invoke.MethodHandles.lookup())
