...
public class PHP_Token_GLOBAL extends PHP_Token {

    public PHP_Token_GLOBAL(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_GLOBAL.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_GLOBAL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_GLOBAL")
                    .setLookup(PHP_Token_GLOBAL.class, java.lang.invoke.MethodHandles.lookup())
