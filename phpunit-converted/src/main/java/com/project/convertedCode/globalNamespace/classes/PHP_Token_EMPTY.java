...
public class PHP_Token_EMPTY extends PHP_Token {

    public PHP_Token_EMPTY(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_EMPTY.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_EMPTY";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_EMPTY")
                    .setLookup(PHP_Token_EMPTY.class, java.lang.invoke.MethodHandles.lookup())
