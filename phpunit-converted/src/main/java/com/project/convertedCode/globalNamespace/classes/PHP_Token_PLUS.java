...
public class PHP_Token_PLUS extends PHP_Token {

    public PHP_Token_PLUS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_PLUS.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_PLUS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_PLUS")
                    .setLookup(PHP_Token_PLUS.class, java.lang.invoke.MethodHandles.lookup())
