...
public class PHP_Token_DOUBLE_ARROW extends PHP_Token {

    public PHP_Token_DOUBLE_ARROW(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DOUBLE_ARROW.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DOUBLE_ARROW";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DOUBLE_ARROW")
                    .setLookup(
                            PHP_Token_DOUBLE_ARROW.class, java.lang.invoke.MethodHandles.lookup())
