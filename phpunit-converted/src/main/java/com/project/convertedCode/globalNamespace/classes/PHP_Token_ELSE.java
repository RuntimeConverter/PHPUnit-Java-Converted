...
public class PHP_Token_ELSE extends PHP_Token {

    public PHP_Token_ELSE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ELSE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ELSE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ELSE")
                    .setLookup(PHP_Token_ELSE.class, java.lang.invoke.MethodHandles.lookup())
