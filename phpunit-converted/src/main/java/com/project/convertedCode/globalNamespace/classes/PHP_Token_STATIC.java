...
public class PHP_Token_STATIC extends PHP_Token {

    public PHP_Token_STATIC(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_STATIC.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_STATIC";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_STATIC")
                    .setLookup(PHP_Token_STATIC.class, java.lang.invoke.MethodHandles.lookup())
