...
public class PHP_Token_NS_SEPARATOR extends PHP_Token {

    public PHP_Token_NS_SEPARATOR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_NS_SEPARATOR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_NS_SEPARATOR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_NS_SEPARATOR")
                    .setLookup(
                            PHP_Token_NS_SEPARATOR.class, java.lang.invoke.MethodHandles.lookup())
