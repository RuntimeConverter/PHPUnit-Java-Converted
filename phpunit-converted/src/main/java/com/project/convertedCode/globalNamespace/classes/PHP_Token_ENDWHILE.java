...
public class PHP_Token_ENDWHILE extends PHP_Token {

    public PHP_Token_ENDWHILE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ENDWHILE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ENDWHILE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ENDWHILE")
                    .setLookup(PHP_Token_ENDWHILE.class, java.lang.invoke.MethodHandles.lookup())
