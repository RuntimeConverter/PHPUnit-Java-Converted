...
public class Var_ extends BaseTag implements StaticMethod {

    public Object name = "var";

    public Object type = null;

    public Object variableName = "";

    public Var_(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Var_.class) {
    ...
    public static final Object CONST_class = "phpDocumentor\\Reflection\\DocBlock\\Tags\\Var_";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("phpDocumentor\\Reflection\\DocBlock\\Tags\\Var_")
                    .setLookup(Var_.class, java.lang.invoke.MethodHandles.lookup())
