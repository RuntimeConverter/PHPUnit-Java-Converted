...
public class PHP_Token_CASE extends PHP_Token {

    public PHP_Token_CASE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CASE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CASE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CASE")
                    .setLookup(PHP_Token_CASE.class, java.lang.invoke.MethodHandles.lookup())
