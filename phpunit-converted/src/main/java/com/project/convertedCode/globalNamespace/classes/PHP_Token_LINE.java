...
public class PHP_Token_LINE extends PHP_Token {

    public PHP_Token_LINE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_LINE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_LINE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_LINE")
                    .setLookup(PHP_Token_LINE.class, java.lang.invoke.MethodHandles.lookup())
