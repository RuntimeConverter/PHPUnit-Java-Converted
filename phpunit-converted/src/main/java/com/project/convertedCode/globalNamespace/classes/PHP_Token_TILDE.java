...
public class PHP_Token_TILDE extends PHP_Token {

    public PHP_Token_TILDE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_TILDE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_TILDE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_TILDE")
                    .setLookup(PHP_Token_TILDE.class, java.lang.invoke.MethodHandles.lookup())
