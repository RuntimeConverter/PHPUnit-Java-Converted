...
public class PHP_Token_PIPE extends PHP_Token {

    public PHP_Token_PIPE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_PIPE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_PIPE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_PIPE")
                    .setLookup(PHP_Token_PIPE.class, java.lang.invoke.MethodHandles.lookup())
