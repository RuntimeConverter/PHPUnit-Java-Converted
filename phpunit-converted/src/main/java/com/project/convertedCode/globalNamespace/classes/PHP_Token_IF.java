...
public class PHP_Token_IF extends PHP_Token {

    public PHP_Token_IF(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_IF.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_IF";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_IF")
                    .setLookup(PHP_Token_IF.class, java.lang.invoke.MethodHandles.lookup())
