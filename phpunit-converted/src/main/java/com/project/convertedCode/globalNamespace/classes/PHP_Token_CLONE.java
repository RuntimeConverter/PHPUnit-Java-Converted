...
public class PHP_Token_CLONE extends PHP_Token {

    public PHP_Token_CLONE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CLONE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CLONE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CLONE")
                    .setLookup(PHP_Token_CLONE.class, java.lang.invoke.MethodHandles.lookup())
