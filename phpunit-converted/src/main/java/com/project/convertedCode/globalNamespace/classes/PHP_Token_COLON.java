...
public class PHP_Token_COLON extends PHP_Token {

    public PHP_Token_COLON(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_COLON.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_COLON";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_COLON")
                    .setLookup(PHP_Token_COLON.class, java.lang.invoke.MethodHandles.lookup())
