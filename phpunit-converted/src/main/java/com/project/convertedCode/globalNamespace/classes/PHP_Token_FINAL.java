...
public class PHP_Token_FINAL extends PHP_Token {

    public PHP_Token_FINAL(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_FINAL.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_FINAL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_FINAL")
                    .setLookup(PHP_Token_FINAL.class, java.lang.invoke.MethodHandles.lookup())
