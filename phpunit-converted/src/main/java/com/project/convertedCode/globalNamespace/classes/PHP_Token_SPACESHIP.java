...
public class PHP_Token_SPACESHIP extends PHP_Token {

    public PHP_Token_SPACESHIP(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_SPACESHIP.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_SPACESHIP";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_SPACESHIP")
                    .setLookup(PHP_Token_SPACESHIP.class, java.lang.invoke.MethodHandles.lookup())
