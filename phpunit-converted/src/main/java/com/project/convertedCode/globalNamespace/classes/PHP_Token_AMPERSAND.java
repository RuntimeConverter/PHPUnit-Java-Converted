...
public class PHP_Token_AMPERSAND extends PHP_Token {

    public PHP_Token_AMPERSAND(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_AMPERSAND.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_AMPERSAND";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_AMPERSAND")
                    .setLookup(PHP_Token_AMPERSAND.class, java.lang.invoke.MethodHandles.lookup())
