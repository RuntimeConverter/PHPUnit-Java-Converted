...
public class PHP_Token_IMPLEMENTS extends PHP_Token {

    public PHP_Token_IMPLEMENTS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_IMPLEMENTS.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_IMPLEMENTS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_IMPLEMENTS")
                    .setLookup(PHP_Token_IMPLEMENTS.class, java.lang.invoke.MethodHandles.lookup())
