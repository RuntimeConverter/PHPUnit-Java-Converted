...
public class assertFileNotExists extends FunctionBaseRegular {

    public static assertFileNotExists f = new assertFileNotExists();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertFileNotExists(
                env,
