...
public class PHP_Token_GOTO extends PHP_Token {

    public PHP_Token_GOTO(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_GOTO.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_GOTO";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_GOTO")
                    .setLookup(PHP_Token_GOTO.class, java.lang.invoke.MethodHandles.lookup())
