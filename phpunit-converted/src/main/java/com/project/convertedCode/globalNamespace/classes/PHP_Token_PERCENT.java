...
public class PHP_Token_PERCENT extends PHP_Token {

    public PHP_Token_PERCENT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_PERCENT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_PERCENT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_PERCENT")
                    .setLookup(PHP_Token_PERCENT.class, java.lang.invoke.MethodHandles.lookup())
