...
public class PHP_Token_IS_IDENTICAL extends PHP_Token {

    public PHP_Token_IS_IDENTICAL(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_IS_IDENTICAL.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_IS_IDENTICAL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_IS_IDENTICAL")
                    .setLookup(
                            PHP_Token_IS_IDENTICAL.class, java.lang.invoke.MethodHandles.lookup())
