...
public class PHP_Token_LNUMBER extends PHP_Token {

    public PHP_Token_LNUMBER(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_LNUMBER.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_LNUMBER";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_LNUMBER")
                    .setLookup(PHP_Token_LNUMBER.class, java.lang.invoke.MethodHandles.lookup())
