...
public class ManifestDocumentException extends RuntimeException implements Exception {

    public ManifestDocumentException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == ManifestDocumentException.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PharIo\\Manifest\\ManifestDocumentException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PharIo\\Manifest\\ManifestDocumentException")
                    .setLookup(
                            ManifestDocumentException.class,
