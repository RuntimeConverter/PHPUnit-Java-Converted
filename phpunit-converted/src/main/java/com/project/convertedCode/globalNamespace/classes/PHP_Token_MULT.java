...
public class PHP_Token_MULT extends PHP_Token {

    public PHP_Token_MULT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_MULT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_MULT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_MULT")
                    .setLookup(PHP_Token_MULT.class, java.lang.invoke.MethodHandles.lookup())
