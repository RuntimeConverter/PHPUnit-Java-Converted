...
public class PHP_Token_AT extends PHP_Token {

    public PHP_Token_AT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_AT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_AT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_AT")
                    .setLookup(PHP_Token_AT.class, java.lang.invoke.MethodHandles.lookup())
