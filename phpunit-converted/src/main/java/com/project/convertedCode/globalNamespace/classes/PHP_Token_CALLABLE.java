...
public class PHP_Token_CALLABLE extends PHP_Token {

    public PHP_Token_CALLABLE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CALLABLE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CALLABLE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CALLABLE")
                    .setLookup(PHP_Token_CALLABLE.class, java.lang.invoke.MethodHandles.lookup())
