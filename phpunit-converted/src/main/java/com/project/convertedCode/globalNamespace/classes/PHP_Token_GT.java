...
public class PHP_Token_GT extends PHP_Token {

    public PHP_Token_GT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_GT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_GT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_GT")
                    .setLookup(PHP_Token_GT.class, java.lang.invoke.MethodHandles.lookup())
