...
public class PHP_Token_ENDFOREACH extends PHP_Token {

    public PHP_Token_ENDFOREACH(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ENDFOREACH.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ENDFOREACH";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ENDFOREACH")
                    .setLookup(PHP_Token_ENDFOREACH.class, java.lang.invoke.MethodHandles.lookup())
