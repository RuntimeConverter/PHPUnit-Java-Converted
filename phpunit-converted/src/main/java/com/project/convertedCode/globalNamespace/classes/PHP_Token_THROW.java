...
public class PHP_Token_THROW extends PHP_Token {

    public PHP_Token_THROW(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_THROW.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_THROW";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_THROW")
                    .setLookup(PHP_Token_THROW.class, java.lang.invoke.MethodHandles.lookup())
