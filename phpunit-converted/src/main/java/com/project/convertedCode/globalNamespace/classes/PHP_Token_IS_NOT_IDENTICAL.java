...
public class PHP_Token_IS_NOT_IDENTICAL extends PHP_Token {

    public PHP_Token_IS_NOT_IDENTICAL(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_IS_NOT_IDENTICAL.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_IS_NOT_IDENTICAL";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_IS_NOT_IDENTICAL")
                    .setLookup(
                            PHP_Token_IS_NOT_IDENTICAL.class,
