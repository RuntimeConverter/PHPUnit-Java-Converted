...
public class PHP_Token_WHITESPACE extends PHP_Token {

    public PHP_Token_WHITESPACE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_WHITESPACE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_WHITESPACE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_WHITESPACE")
                    .setLookup(PHP_Token_WHITESPACE.class, java.lang.invoke.MethodHandles.lookup())
