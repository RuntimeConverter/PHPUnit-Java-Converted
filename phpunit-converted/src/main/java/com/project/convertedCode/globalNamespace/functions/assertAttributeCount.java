...
public class assertAttributeCount extends FunctionBaseRegular {

    public static assertAttributeCount f = new assertAttributeCount();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertAttributeCount(
                env,
