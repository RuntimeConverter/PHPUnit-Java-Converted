...
public class PHP_Token_EXCLAMATION_MARK extends PHP_Token {

    public PHP_Token_EXCLAMATION_MARK(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_EXCLAMATION_MARK.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_EXCLAMATION_MARK";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_EXCLAMATION_MARK")
                    .setLookup(
