...
public class assertAttributeEmpty extends FunctionBaseRegular {

    public static assertAttributeEmpty f = new assertAttributeEmpty();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertAttributeEmpty(
                env,
