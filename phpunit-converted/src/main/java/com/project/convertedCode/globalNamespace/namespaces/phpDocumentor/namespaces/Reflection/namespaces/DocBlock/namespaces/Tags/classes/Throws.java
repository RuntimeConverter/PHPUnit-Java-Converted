...
public final class Throws extends BaseTag implements StaticMethod {

    public Object name = "throws";

    public Object type = null;

    public Throws(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == Throws.class) {
    ...
    public static final Object CONST_class = "phpDocumentor\\Reflection\\DocBlock\\Tags\\Throws";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("phpDocumentor\\Reflection\\DocBlock\\Tags\\Throws")
                    .setLookup(Throws.class, java.lang.invoke.MethodHandles.lookup())
