...
public class PHP_Token_CHARACTER extends PHP_Token {

    public PHP_Token_CHARACTER(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CHARACTER.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CHARACTER";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CHARACTER")
                    .setLookup(PHP_Token_CHARACTER.class, java.lang.invoke.MethodHandles.lookup())
