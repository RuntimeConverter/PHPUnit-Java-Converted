...
public class PHP_Token_DOLLAR extends PHP_Token {

    public PHP_Token_DOLLAR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DOLLAR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DOLLAR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DOLLAR")
                    .setLookup(PHP_Token_DOLLAR.class, java.lang.invoke.MethodHandles.lookup())
