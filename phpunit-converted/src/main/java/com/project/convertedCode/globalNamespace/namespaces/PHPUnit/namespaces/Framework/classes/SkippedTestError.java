...
public class SkippedTestError extends AssertionFailedError implements SkippedTest {

    public SkippedTestError(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == SkippedTestError.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHPUnit\\Framework\\SkippedTestError";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Framework\\SkippedTestError")
                    .setLookup(SkippedTestError.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties("serializableTrace")
                    .setFilename("vendor/phpunit/phpunit/src/Framework/SkippedTestError.php")
