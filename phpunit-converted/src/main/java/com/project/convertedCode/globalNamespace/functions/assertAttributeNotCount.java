...
public class assertAttributeNotCount extends FunctionBaseRegular {

    public static assertAttributeNotCount f = new assertAttributeNotCount();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertAttributeNotCount(
                env,
