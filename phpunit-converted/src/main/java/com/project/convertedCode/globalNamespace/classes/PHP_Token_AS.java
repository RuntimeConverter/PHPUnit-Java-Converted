...
public class PHP_Token_AS extends PHP_Token {

    public PHP_Token_AS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_AS.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_AS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_AS")
                    .setLookup(PHP_Token_AS.class, java.lang.invoke.MethodHandles.lookup())
