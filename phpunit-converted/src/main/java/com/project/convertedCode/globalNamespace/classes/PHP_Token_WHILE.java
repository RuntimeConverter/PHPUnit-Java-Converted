...
public class PHP_Token_WHILE extends PHP_Token {

    public PHP_Token_WHILE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_WHILE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_WHILE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_WHILE")
                    .setLookup(PHP_Token_WHILE.class, java.lang.invoke.MethodHandles.lookup())
