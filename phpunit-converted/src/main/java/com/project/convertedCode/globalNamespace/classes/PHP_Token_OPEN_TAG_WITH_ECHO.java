...
public class PHP_Token_OPEN_TAG_WITH_ECHO extends PHP_Token {

    public PHP_Token_OPEN_TAG_WITH_ECHO(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_OPEN_TAG_WITH_ECHO.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_OPEN_TAG_WITH_ECHO";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_OPEN_TAG_WITH_ECHO")
                    .setLookup(
                            PHP_Token_OPEN_TAG_WITH_ECHO.class,
