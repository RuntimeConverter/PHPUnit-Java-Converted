...
public class IncompleteTestCase extends TestCase {
    ...
    public IncompleteTestCase(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == IncompleteTestCase.class) {
    ...
    public Object toString(RuntimeEnv env, Object... args) {
        return ZVal.assign(env.callMethod(this, "getName", IncompleteTestCase.class));
    }
    ...
    public static final Object CONST_class = "PHPUnit\\Framework\\IncompleteTestCase";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Framework\\IncompleteTestCase")
                    .setLookup(IncompleteTestCase.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties(
                            "backupGlobals",
                            "backupGlobals",
                            ...
                            "useOutputBuffering",
                            "warnings")
                    .setFilename("vendor/phpunit/phpunit/src/Framework/IncompleteTestCase.php")
                    .addInterface("Test")
