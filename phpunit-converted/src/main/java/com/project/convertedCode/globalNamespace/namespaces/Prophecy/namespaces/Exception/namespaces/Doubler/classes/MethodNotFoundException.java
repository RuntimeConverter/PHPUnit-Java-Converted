...
public class MethodNotFoundException extends DoubleException {
    ...
    public MethodNotFoundException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == MethodNotFoundException.class) {
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("Prophecy\\Exception\\Doubler\\MethodNotFoundException")
                    .setLookup(
                            MethodNotFoundException.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties("arguments", "classname", "methodName")
                    .setFilename(
                            "vendor/phpspec/prophecy/src/Prophecy/Exception/Doubler/MethodNotFoundException.php")
