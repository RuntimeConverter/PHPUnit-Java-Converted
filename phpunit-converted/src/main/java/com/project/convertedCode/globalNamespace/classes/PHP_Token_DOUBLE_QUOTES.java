...
public class PHP_Token_DOUBLE_QUOTES extends PHP_Token {

    public PHP_Token_DOUBLE_QUOTES(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DOUBLE_QUOTES.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DOUBLE_QUOTES";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DOUBLE_QUOTES")
                    .setLookup(
                            PHP_Token_DOUBLE_QUOTES.class, java.lang.invoke.MethodHandles.lookup())
