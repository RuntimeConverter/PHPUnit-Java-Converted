...
public class PHP_Token_PUBLIC extends PHP_Token {

    public PHP_Token_PUBLIC(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_PUBLIC.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_PUBLIC";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_PUBLIC")
                    .setLookup(PHP_Token_PUBLIC.class, java.lang.invoke.MethodHandles.lookup())
