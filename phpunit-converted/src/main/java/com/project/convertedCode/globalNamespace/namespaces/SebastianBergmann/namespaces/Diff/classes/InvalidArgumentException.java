...
import com.project.convertedCode.globalNamespace.namespaces.SebastianBergmann.namespaces.Diff.classes.Exception;
...
public class InvalidArgumentException
    ...
    public static final Object CONST_class = "SebastianBergmann\\Diff\\InvalidArgumentException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("SebastianBergmann\\Diff\\InvalidArgumentException")
                    .setLookup(
                            InvalidArgumentException.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties()
                    .setFilename("vendor/sebastian/diff/src/Exception/InvalidArgumentException.php")
