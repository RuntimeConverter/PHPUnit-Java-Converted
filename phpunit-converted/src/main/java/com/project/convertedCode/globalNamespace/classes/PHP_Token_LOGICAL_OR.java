...
public class PHP_Token_LOGICAL_OR extends PHP_Token {

    public PHP_Token_LOGICAL_OR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_LOGICAL_OR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_LOGICAL_OR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_LOGICAL_OR")
                    .setLookup(PHP_Token_LOGICAL_OR.class, java.lang.invoke.MethodHandles.lookup())
