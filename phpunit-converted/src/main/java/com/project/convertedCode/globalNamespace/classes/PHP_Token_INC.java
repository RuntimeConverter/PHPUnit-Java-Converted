...
public class PHP_Token_INC extends PHP_Token {

    public PHP_Token_INC(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_INC.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_INC";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_INC")
                    .setLookup(PHP_Token_INC.class, java.lang.invoke.MethodHandles.lookup())
