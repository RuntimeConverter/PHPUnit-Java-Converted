...
public class PHP_Token_CATCH extends PHP_Token {

    public PHP_Token_CATCH(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CATCH.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CATCH";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CATCH")
                    .setLookup(PHP_Token_CATCH.class, java.lang.invoke.MethodHandles.lookup())
