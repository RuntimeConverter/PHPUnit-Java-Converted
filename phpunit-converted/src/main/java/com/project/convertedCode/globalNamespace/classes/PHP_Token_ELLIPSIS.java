...
public class PHP_Token_ELLIPSIS extends PHP_Token {

    public PHP_Token_ELLIPSIS(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ELLIPSIS.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ELLIPSIS";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ELLIPSIS")
                    .setLookup(PHP_Token_ELLIPSIS.class, java.lang.invoke.MethodHandles.lookup())
