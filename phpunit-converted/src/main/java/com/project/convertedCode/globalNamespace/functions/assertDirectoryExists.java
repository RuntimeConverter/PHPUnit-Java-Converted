...
public class assertDirectoryExists extends FunctionBaseRegular {

    public static assertDirectoryExists f = new assertDirectoryExists();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertDirectoryExists(
                env,
