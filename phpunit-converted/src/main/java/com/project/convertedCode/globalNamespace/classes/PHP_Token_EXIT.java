...
public class PHP_Token_EXIT extends PHP_Token {

    public PHP_Token_EXIT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_EXIT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_EXIT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_EXIT")
                    .setLookup(PHP_Token_EXIT.class, java.lang.invoke.MethodHandles.lookup())
