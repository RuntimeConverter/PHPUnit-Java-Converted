...
public class PHP_Token_CONST extends PHP_Token {

    public PHP_Token_CONST(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CONST.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CONST";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CONST")
                    .setLookup(PHP_Token_CONST.class, java.lang.invoke.MethodHandles.lookup())
