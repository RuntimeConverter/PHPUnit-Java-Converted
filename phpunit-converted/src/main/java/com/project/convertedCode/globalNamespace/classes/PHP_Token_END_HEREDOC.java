...
public class PHP_Token_END_HEREDOC extends PHP_Token {

    public PHP_Token_END_HEREDOC(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_END_HEREDOC.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_END_HEREDOC";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_END_HEREDOC")
                    .setLookup(PHP_Token_END_HEREDOC.class, java.lang.invoke.MethodHandles.lookup())
