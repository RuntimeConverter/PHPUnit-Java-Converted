...
public class assertFileExists extends FunctionBaseRegular {

    public static assertFileExists f = new assertFileExists();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertFileExists(
                env,
