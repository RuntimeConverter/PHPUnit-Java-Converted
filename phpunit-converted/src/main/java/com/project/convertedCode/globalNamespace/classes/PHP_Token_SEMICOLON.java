...
public class PHP_Token_SEMICOLON extends PHP_Token {

    public PHP_Token_SEMICOLON(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_SEMICOLON.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_SEMICOLON";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_SEMICOLON")
                    .setLookup(PHP_Token_SEMICOLON.class, java.lang.invoke.MethodHandles.lookup())
