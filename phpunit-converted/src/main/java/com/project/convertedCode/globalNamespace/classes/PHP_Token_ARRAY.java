...
public class PHP_Token_ARRAY extends PHP_Token {

    public PHP_Token_ARRAY(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ARRAY.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ARRAY";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ARRAY")
                    .setLookup(PHP_Token_ARRAY.class, java.lang.invoke.MethodHandles.lookup())
