...
public class PHP_Token_USE_FUNCTION extends PHP_Token {

    public PHP_Token_USE_FUNCTION(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_USE_FUNCTION.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_USE_FUNCTION";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_USE_FUNCTION")
                    .setLookup(
                            PHP_Token_USE_FUNCTION.class, java.lang.invoke.MethodHandles.lookup())
