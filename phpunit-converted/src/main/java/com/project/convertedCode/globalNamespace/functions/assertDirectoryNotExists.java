...
public class assertDirectoryNotExists extends FunctionBaseRegular {

    public static assertDirectoryNotExists f = new assertDirectoryNotExists();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertDirectoryNotExists(
                env,
