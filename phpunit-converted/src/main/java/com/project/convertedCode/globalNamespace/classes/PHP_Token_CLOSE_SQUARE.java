...
public class PHP_Token_CLOSE_SQUARE extends PHP_Token {

    public PHP_Token_CLOSE_SQUARE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CLOSE_SQUARE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CLOSE_SQUARE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CLOSE_SQUARE")
                    .setLookup(
                            PHP_Token_CLOSE_SQUARE.class, java.lang.invoke.MethodHandles.lookup())
