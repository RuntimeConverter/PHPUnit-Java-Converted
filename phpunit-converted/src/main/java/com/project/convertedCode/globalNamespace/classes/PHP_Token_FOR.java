...
public class PHP_Token_FOR extends PHP_Token {

    public PHP_Token_FOR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_FOR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_FOR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_FOR")
                    .setLookup(PHP_Token_FOR.class, java.lang.invoke.MethodHandles.lookup())
