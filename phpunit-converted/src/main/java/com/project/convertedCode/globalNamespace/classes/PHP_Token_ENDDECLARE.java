...
public class PHP_Token_ENDDECLARE extends PHP_Token {

    public PHP_Token_ENDDECLARE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ENDDECLARE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ENDDECLARE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ENDDECLARE")
                    .setLookup(PHP_Token_ENDDECLARE.class, java.lang.invoke.MethodHandles.lookup())
