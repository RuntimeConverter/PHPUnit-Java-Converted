...
public class UnintentionallyCoveredCodeError extends RiskyTestError {

    public UnintentionallyCoveredCodeError(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == UnintentionallyCoveredCodeError.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHPUnit\\Framework\\UnintentionallyCoveredCodeError";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Framework\\UnintentionallyCoveredCodeError")
                    .setLookup(
                            UnintentionallyCoveredCodeError.class,
