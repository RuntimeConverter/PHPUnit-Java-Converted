...
public class PHP_Token_OPEN_TAG extends PHP_Token {

    public PHP_Token_OPEN_TAG(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_OPEN_TAG.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_OPEN_TAG";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_OPEN_TAG")
                    .setLookup(PHP_Token_OPEN_TAG.class, java.lang.invoke.MethodHandles.lookup())
