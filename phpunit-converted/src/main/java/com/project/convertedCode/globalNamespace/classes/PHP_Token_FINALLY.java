...
public class PHP_Token_FINALLY extends PHP_Token {

    public PHP_Token_FINALLY(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_FINALLY.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_FINALLY";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_FINALLY")
                    .setLookup(PHP_Token_FINALLY.class, java.lang.invoke.MethodHandles.lookup())
