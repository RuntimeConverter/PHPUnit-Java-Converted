...
public class PHP_Token_DEFAULT extends PHP_Token {

    public PHP_Token_DEFAULT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DEFAULT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DEFAULT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DEFAULT")
                    .setLookup(PHP_Token_DEFAULT.class, java.lang.invoke.MethodHandles.lookup())
