...
public class PHP_Token_DNUMBER extends PHP_Token {

    public PHP_Token_DNUMBER(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DNUMBER.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DNUMBER";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DNUMBER")
                    .setLookup(PHP_Token_DNUMBER.class, java.lang.invoke.MethodHandles.lookup())
