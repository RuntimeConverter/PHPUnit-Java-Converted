...
public class PHP_Token_DECLARE extends PHP_Token {

    public PHP_Token_DECLARE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DECLARE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DECLARE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DECLARE")
                    .setLookup(PHP_Token_DECLARE.class, java.lang.invoke.MethodHandles.lookup())
