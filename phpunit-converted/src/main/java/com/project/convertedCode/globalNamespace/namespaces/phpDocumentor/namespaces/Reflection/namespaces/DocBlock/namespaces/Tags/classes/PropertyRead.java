...
public class PropertyRead extends BaseTag implements StaticMethod {

    public Object name = "property-read";

    public Object type = null;

    public Object variableName = "";

    public PropertyRead(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PropertyRead.class) {
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("phpDocumentor\\Reflection\\DocBlock\\Tags\\PropertyRead")
                    .setLookup(PropertyRead.class, java.lang.invoke.MethodHandles.lookup())
