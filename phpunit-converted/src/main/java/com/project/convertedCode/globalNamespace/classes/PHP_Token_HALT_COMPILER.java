...
public class PHP_Token_HALT_COMPILER extends PHP_Token {

    public PHP_Token_HALT_COMPILER(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_HALT_COMPILER.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_HALT_COMPILER";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_HALT_COMPILER")
                    .setLookup(
                            PHP_Token_HALT_COMPILER.class, java.lang.invoke.MethodHandles.lookup())
