...
public class PHP_Token_INSTEADOF extends PHP_Token {

    public PHP_Token_INSTEADOF(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_INSTEADOF.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_INSTEADOF";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_INSTEADOF")
                    .setLookup(PHP_Token_INSTEADOF.class, java.lang.invoke.MethodHandles.lookup())
