...
public class PHP_Token_OPEN_BRACKET extends PHP_Token {

    public PHP_Token_OPEN_BRACKET(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_OPEN_BRACKET.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_OPEN_BRACKET";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_OPEN_BRACKET")
                    .setLookup(
                            PHP_Token_OPEN_BRACKET.class, java.lang.invoke.MethodHandles.lookup())
