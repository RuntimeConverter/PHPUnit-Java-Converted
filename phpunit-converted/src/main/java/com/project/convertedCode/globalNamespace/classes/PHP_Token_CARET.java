...
public class PHP_Token_CARET extends PHP_Token {

    public PHP_Token_CARET(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CARET.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CARET";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CARET")
                    .setLookup(PHP_Token_CARET.class, java.lang.invoke.MethodHandles.lookup())
