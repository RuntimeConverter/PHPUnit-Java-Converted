...
public class PHP_Token_TRY extends PHP_Token {

    public PHP_Token_TRY(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_TRY.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_TRY";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_TRY")
                    .setLookup(PHP_Token_TRY.class, java.lang.invoke.MethodHandles.lookup())
