...
public class PHP_Token_PRINT extends PHP_Token {

    public PHP_Token_PRINT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_PRINT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_PRINT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_PRINT")
                    .setLookup(PHP_Token_PRINT.class, java.lang.invoke.MethodHandles.lookup())
