...
public class PHP_Token_UNSET extends PHP_Token {

    public PHP_Token_UNSET(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_UNSET.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_UNSET";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_UNSET")
                    .setLookup(PHP_Token_UNSET.class, java.lang.invoke.MethodHandles.lookup())
