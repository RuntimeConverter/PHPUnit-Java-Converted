...
public class PHP_Token_BACKTICK extends PHP_Token {

    public PHP_Token_BACKTICK(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_BACKTICK.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_BACKTICK";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_BACKTICK")
                    .setLookup(PHP_Token_BACKTICK.class, java.lang.invoke.MethodHandles.lookup())
