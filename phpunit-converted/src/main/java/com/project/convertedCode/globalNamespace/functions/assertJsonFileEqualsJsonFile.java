...
public class assertJsonFileEqualsJsonFile extends FunctionBaseRegular {

    public static assertJsonFileEqualsJsonFile f = new assertJsonFileEqualsJsonFile();
    ...
    public Object call(RuntimeEnv env, Object... args) {
        ...
        Assert.runtimeStaticObject.assertJsonFileEqualsJsonFile(
                env,
