...
public class PHP_Token_RETURN extends PHP_Token {

    public PHP_Token_RETURN(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_RETURN.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_RETURN";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_RETURN")
                    .setLookup(PHP_Token_RETURN.class, java.lang.invoke.MethodHandles.lookup())
