...
public class PHP_Token_DEC extends PHP_Token {

    public PHP_Token_DEC(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DEC.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DEC";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DEC")
                    .setLookup(PHP_Token_DEC.class, java.lang.invoke.MethodHandles.lookup())
