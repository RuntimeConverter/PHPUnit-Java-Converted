...
public class PHP_Token_POW extends PHP_Token {

    public PHP_Token_POW(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_POW.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_POW";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_POW")
                    .setLookup(PHP_Token_POW.class, java.lang.invoke.MethodHandles.lookup())
