...
public class PHP_Token_LOGICAL_XOR extends PHP_Token {

    public PHP_Token_LOGICAL_XOR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_LOGICAL_XOR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_LOGICAL_XOR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_LOGICAL_XOR")
                    .setLookup(PHP_Token_LOGICAL_XOR.class, java.lang.invoke.MethodHandles.lookup())
