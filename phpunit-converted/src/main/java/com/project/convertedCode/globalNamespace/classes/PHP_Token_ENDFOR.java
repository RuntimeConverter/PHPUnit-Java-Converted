...
public class PHP_Token_ENDFOR extends PHP_Token {

    public PHP_Token_ENDFOR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ENDFOR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ENDFOR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ENDFOR")
                    .setLookup(PHP_Token_ENDFOR.class, java.lang.invoke.MethodHandles.lookup())
