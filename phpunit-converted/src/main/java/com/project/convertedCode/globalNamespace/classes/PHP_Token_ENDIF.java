...
public class PHP_Token_ENDIF extends PHP_Token {

    public PHP_Token_ENDIF(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ENDIF.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ENDIF";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ENDIF")
                    .setLookup(PHP_Token_ENDIF.class, java.lang.invoke.MethodHandles.lookup())
