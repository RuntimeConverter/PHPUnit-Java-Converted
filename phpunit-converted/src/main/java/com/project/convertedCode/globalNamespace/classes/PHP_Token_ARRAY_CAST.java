...
public class PHP_Token_ARRAY_CAST extends PHP_Token {

    public PHP_Token_ARRAY_CAST(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_ARRAY_CAST.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_ARRAY_CAST";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_ARRAY_CAST")
                    .setLookup(PHP_Token_ARRAY_CAST.class, java.lang.invoke.MethodHandles.lookup())
