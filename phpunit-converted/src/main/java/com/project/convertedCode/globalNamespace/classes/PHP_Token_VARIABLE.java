...
public class PHP_Token_VARIABLE extends PHP_Token {

    public PHP_Token_VARIABLE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_VARIABLE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_VARIABLE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_VARIABLE")
                    .setLookup(PHP_Token_VARIABLE.class, java.lang.invoke.MethodHandles.lookup())
