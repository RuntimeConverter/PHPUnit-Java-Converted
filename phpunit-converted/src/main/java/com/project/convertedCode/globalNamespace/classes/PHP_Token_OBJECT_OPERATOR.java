...
public class PHP_Token_OBJECT_OPERATOR extends PHP_Token {

    public PHP_Token_OBJECT_OPERATOR(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_OBJECT_OPERATOR.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_OBJECT_OPERATOR";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_OBJECT_OPERATOR")
                    .setLookup(
