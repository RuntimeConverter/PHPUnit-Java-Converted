...
public class PHP_Token_NEW extends PHP_Token {

    public PHP_Token_NEW(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_NEW.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_NEW";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_NEW")
                    .setLookup(PHP_Token_NEW.class, java.lang.invoke.MethodHandles.lookup())
