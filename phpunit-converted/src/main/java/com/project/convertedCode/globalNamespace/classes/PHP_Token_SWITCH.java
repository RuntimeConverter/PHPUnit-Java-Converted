...
public class PHP_Token_SWITCH extends PHP_Token {

    public PHP_Token_SWITCH(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_SWITCH.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_SWITCH";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_SWITCH")
                    .setLookup(PHP_Token_SWITCH.class, java.lang.invoke.MethodHandles.lookup())
