...
public class CodeCoverageException extends Exception {
    ...
    public CodeCoverageException(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == CodeCoverageException.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHPUnit\\Framework\\CodeCoverageException";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHPUnit\\Framework\\CodeCoverageException")
                    .setLookup(CodeCoverageException.class, java.lang.invoke.MethodHandles.lookup())
                    .setLocalProperties("serializableTrace")
                    .setFilename("vendor/phpunit/phpunit/src/Framework/CodeCoverageException.php")
