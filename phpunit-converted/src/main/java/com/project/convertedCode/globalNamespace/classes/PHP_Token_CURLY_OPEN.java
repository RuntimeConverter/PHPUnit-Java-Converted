...
public class PHP_Token_CURLY_OPEN extends PHP_Token {

    public PHP_Token_CURLY_OPEN(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CURLY_OPEN.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CURLY_OPEN";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CURLY_OPEN")
                    .setLookup(PHP_Token_CURLY_OPEN.class, java.lang.invoke.MethodHandles.lookup())
