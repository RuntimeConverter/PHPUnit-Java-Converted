...
public class PHP_Token_CLASS_NAME_CONSTANT extends PHP_Token {

    public PHP_Token_CLASS_NAME_CONSTANT(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_CLASS_NAME_CONSTANT.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_CLASS_NAME_CONSTANT";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_CLASS_NAME_CONSTANT")
                    .setLookup(
                            PHP_Token_CLASS_NAME_CONSTANT.class,
