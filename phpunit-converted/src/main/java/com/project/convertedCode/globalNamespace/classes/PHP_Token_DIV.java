...
public class PHP_Token_DIV extends PHP_Token {

    public PHP_Token_DIV(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_DIV.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_DIV";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_DIV")
                    .setLookup(PHP_Token_DIV.class, java.lang.invoke.MethodHandles.lookup())
