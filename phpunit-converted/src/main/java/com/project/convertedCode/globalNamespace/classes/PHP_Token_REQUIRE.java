...
public class PHP_Token_REQUIRE extends PHP_Token_Includes {

    public PHP_Token_REQUIRE(RuntimeEnv env, Object... args) {
        super(env);
        if (this.getClass() == PHP_Token_REQUIRE.class) {
            this.__construct(env, args);
        }
    }

    public static final Object CONST_class = "PHP_Token_REQUIRE";
    ...
    private static final ReflectionClassData runtimeConverterReflectionData =
            ReflectionClassData.builder()
                    .setName("PHP_Token_REQUIRE")
                    .setLookup(PHP_Token_REQUIRE.class, java.lang.invoke.MethodHandles.lookup())
