...
public class file_Self__php implements RuntimeIncludable {

    public static final file_Self__php instance = new file_Self__php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope203 scope)
        ...
        // Conversion Note: class named Self_ was here in the source code
        env.addManualClassLoad("phpDocumentor\\Reflection\\Types\\Self_");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpdocumentor/type-resolver/src/Types")
                    .setFile("/vendor/phpdocumentor/type-resolver/src/Types/Self_.php");
