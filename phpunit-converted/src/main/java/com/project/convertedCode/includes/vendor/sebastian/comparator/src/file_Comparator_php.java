...
public class file_Comparator_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope537 scope = new Scope537();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope537 scope)
    ...
    private static class Scope537 implements UpdateRuntimeScopeInterface {
