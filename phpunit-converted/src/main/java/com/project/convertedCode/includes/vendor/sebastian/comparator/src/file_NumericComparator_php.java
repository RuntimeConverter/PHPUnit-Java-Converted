...
public class file_NumericComparator_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope545 scope = new Scope545();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope545 scope)
    ...
    private static class Scope545 implements UpdateRuntimeScopeInterface {
