...
public class file_IdenticalValueToken_php implements RuntimeIncludable {

    public static final file_IdenticalValueToken_php instance = new file_IdenticalValueToken_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope218 scope)
        ...
        // Conversion Note: class named IdenticalValueToken was here in the source code
        env.addManualClassLoad("Prophecy\\Argument\\Token\\IdenticalValueToken");
    }
