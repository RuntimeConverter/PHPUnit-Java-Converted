...
public class file_AfterSuccessfulTestHook_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope488 scope = new Scope488();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope488 scope)
    ...
    private static class Scope488 implements UpdateRuntimeScopeInterface {
