...
public class file_TestResult_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope471 scope = new Scope471();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope471 scope)
    ...
    private static class Scope471 implements UpdateRuntimeScopeInterface {
