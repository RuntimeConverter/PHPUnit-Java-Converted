...
public class file_UnexpectedCallsException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope269 scope = new Scope269();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope269 scope)
    ...
    private static class Scope269 implements UpdateRuntimeScopeInterface {
