...
public class file_GreaterThan_php implements RuntimeIncludable {

    public static final file_GreaterThan_php instance = new file_GreaterThan_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope411 scope)
        ...
        // Conversion Note: class named GreaterThan was here in the source code
        env.addManualClassLoad("PHPUnit\\Framework\\Constraint\\GreaterThan");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpunit/phpunit/src/Framework/Constraint")
                    .setFile("/vendor/phpunit/phpunit/src/Framework/Constraint/GreaterThan.php");
