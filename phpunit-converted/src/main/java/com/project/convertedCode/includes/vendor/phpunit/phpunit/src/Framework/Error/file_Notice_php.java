...
public class file_Notice_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope447 scope = new Scope447();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope447 scope)
    ...
    private static class Scope447 implements UpdateRuntimeScopeInterface {
