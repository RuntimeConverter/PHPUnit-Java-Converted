...
public class file_DoubleInterface_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope240 scope = new Scope240();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope240 scope)
    ...
    private static class Scope240 implements UpdateRuntimeScopeInterface {
