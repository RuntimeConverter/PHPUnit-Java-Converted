...
public class file_Callable__php implements RuntimeIncludable {

    public static final file_Callable__php instance = new file_Callable__php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope189 scope)
        ...
        // Conversion Note: class named Callable_ was here in the source code
        env.addManualClassLoad("phpDocumentor\\Reflection\\Types\\Callable_");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpdocumentor/type-resolver/src/Types")
                    .setFile("/vendor/phpdocumentor/type-resolver/src/Types/Callable_.php");
