...
public class file_ClassCodeGenerator_php implements RuntimeIncludable {

    public static final file_ClassCodeGenerator_php instance = new file_ClassCodeGenerator_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope242 scope)
        ...
        // Conversion Note: class named ClassCodeGenerator was here in the source code
        env.addManualClassLoad("Prophecy\\Doubler\\Generator\\ClassCodeGenerator");
    }
