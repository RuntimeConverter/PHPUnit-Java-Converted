...
public class file_TestHook_php implements RuntimeIncludable {

    public static final file_TestHook_php instance = new file_TestHook_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope495 scope)
        ...
        // Conversion Note: class named TestHook was here in the source code
        env.addManualClassLoad("PHPUnit\\Runner\\TestHook");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpunit/phpunit/src/Runner/Hook")
                    .setFile("/vendor/phpunit/phpunit/src/Runner/Hook/TestHook.php");
