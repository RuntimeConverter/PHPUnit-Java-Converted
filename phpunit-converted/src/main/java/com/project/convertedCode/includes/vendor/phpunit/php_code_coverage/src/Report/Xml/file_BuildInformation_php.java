...
public class file_BuildInformation_php implements RuntimeIncludable {

    public static final file_BuildInformation_php instance = new file_BuildInformation_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope321 scope)
        ...
        // Conversion Note: class named BuildInformation was here in the source code
        env.addManualClassLoad("SebastianBergmann\\CodeCoverage\\Report\\Xml\\BuildInformation");
    }
