...
public class file_ExceptionMessage_php implements RuntimeIncludable {

    public static final file_ExceptionMessage_php instance = new file_ExceptionMessage_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope408 scope)
        ...
        // Conversion Note: class named ExceptionMessage was here in the source code
        env.addManualClassLoad("PHPUnit\\Framework\\Constraint\\ExceptionMessage");
    }
