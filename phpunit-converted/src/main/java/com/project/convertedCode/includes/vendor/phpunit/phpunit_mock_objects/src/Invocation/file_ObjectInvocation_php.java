...
public class file_ObjectInvocation_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope359 scope = new Scope359();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope359 scope)
    ...
    private static class Scope359 implements UpdateRuntimeScopeInterface {
