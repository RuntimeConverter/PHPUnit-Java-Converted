...
public class file_InterfaceNotFoundException_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope258 scope = new Scope258();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope258 scope)
    ...
    private static class Scope258 implements UpdateRuntimeScopeInterface {
