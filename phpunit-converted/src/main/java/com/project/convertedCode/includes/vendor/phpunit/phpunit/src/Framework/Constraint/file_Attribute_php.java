...
public class file_Attribute_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope398 scope = new Scope398();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope398 scope)
    ...
    private static class Scope398 implements UpdateRuntimeScopeInterface {
