...
public class file_Resource__php implements RuntimeIncludable {

    public static final file_Resource__php instance = new file_Resource__php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope201 scope)
        ...
        // Conversion Note: class named Resource_ was here in the source code
        env.addManualClassLoad("phpDocumentor\\Reflection\\Types\\Resource_");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpdocumentor/type-resolver/src/Types")
                    .setFile("/vendor/phpdocumentor/type-resolver/src/Types/Resource_.php");
