...
public class file_TypeToken_php implements RuntimeIncludable {

    public static final file_TypeToken_php instance = new file_TypeToken_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope224 scope)
        ...
        // Conversion Note: class named TypeToken was here in the source code
        env.addManualClassLoad("Prophecy\\Argument\\Token\\TypeToken");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpspec/prophecy/src/Prophecy/Argument/Token")
                    .setFile("/vendor/phpspec/prophecy/src/Prophecy/Argument/Token/TypeToken.php");
