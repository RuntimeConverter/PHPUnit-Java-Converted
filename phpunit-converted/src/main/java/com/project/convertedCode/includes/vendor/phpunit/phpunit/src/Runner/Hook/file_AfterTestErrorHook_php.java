...
public class file_AfterTestErrorHook_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope489 scope = new Scope489();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope489 scope)
    ...
    private static class Scope489 implements UpdateRuntimeScopeInterface {
