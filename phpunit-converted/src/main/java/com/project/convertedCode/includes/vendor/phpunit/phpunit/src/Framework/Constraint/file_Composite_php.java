...
public class file_Composite_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope402 scope = new Scope402();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope402 scope)
    ...
    private static class Scope402 implements UpdateRuntimeScopeInterface {
