...
public class file_Printer_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope521 scope = new Scope521();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope521 scope)
    ...
    private static class Scope521 implements UpdateRuntimeScopeInterface {
