...
public class file_PredictionException_php implements RuntimeIncludable {

    public static final file_PredictionException_php instance = new file_PredictionException_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope267 scope)
        ...
        // Conversion Note: class named PredictionException was here in the source code
        env.addManualClassLoad("Prophecy\\Exception\\Prediction\\PredictionException");
    }
