...
public class file_TestCase_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope467 scope = new Scope467();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope467 scope)
    ...
    private static class Scope467 implements UpdateRuntimeScopeInterface {
