...
public class file_ErrorHandler_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope507 scope = new Scope507();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope507 scope)
    ...
    private static class Scope507 implements UpdateRuntimeScopeInterface {
