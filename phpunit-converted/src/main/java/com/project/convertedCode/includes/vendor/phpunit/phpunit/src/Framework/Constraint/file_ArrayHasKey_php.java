...
public class file_ArrayHasKey_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope396 scope = new Scope396();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope396 scope)
    ...
    private static class Scope396 implements UpdateRuntimeScopeInterface {
