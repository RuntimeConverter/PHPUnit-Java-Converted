...
public class file_Blacklist_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope571 scope = new Scope571();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope571 scope)
    ...
    private static class Scope571 implements UpdateRuntimeScopeInterface {
