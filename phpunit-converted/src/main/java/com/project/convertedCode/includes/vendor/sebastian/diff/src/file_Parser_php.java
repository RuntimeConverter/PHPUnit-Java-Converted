...
public class file_Parser_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope565 scope = new Scope565();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope565 scope)
    ...
    private static class Scope565 implements UpdateRuntimeScopeInterface {
