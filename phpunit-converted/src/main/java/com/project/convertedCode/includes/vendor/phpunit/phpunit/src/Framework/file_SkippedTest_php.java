...
public class file_SkippedTest_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope461 scope = new Scope461();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope461 scope)
    ...
    private static class Scope461 implements UpdateRuntimeScopeInterface {
