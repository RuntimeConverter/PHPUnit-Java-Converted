...
public class file_ClassNotFoundException_php implements RuntimeIncludable {

    public static final file_ClassNotFoundException_php instance =
            new file_ClassNotFoundException_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope255 scope)
        ...
        // Conversion Note: class named ClassNotFoundException was here in the source code
        env.addManualClassLoad("Prophecy\\Exception\\Doubler\\ClassNotFoundException");
    }
