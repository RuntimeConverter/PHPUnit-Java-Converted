...
public class file_CodeExporter_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope572 scope = new Scope572();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope572 scope)
    ...
    private static class Scope572 implements UpdateRuntimeScopeInterface {
