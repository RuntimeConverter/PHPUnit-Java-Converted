...
public class file_CodeCoverage_php implements RuntimeIncludable {

    public static final file_CodeCoverage_php instance = new file_CodeCoverage_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope296 scope)
        ...
        // Namespace import was here
        // Namespace import was here
        // Conversion Note: class named CodeCoverage was here in the source code
        env.addManualClassLoad("SebastianBergmann\\CodeCoverage\\CodeCoverage");
    }
