...
public class file_Unit_php implements RuntimeIncludable {

    public static final file_Unit_php instance = new file_Unit_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope333 scope)
        ...
        // Conversion Note: class named Unit was here in the source code
        env.addManualClassLoad("SebastianBergmann\\CodeCoverage\\Report\\Xml\\Unit");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpunit/php-code-coverage/src/Report/Xml")
                    .setFile("/vendor/phpunit/php-code-coverage/src/Report/Xml/Unit.php");
