...
public class file_IsFinite_php implements RuntimeIncludable {

    public static final file_IsFinite_php instance = new file_IsFinite_php();
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack, Scope416 scope)
        ...
        // Conversion Note: class named IsFinite was here in the source code
        env.addManualClassLoad("PHPUnit\\Framework\\Constraint\\IsFinite");
    }

    private static final ContextConstants runtimeConverterContextContantsInstance =
            new ContextConstants()
                    .setDir("/vendor/phpunit/phpunit/src/Framework/Constraint")
                    .setFile("/vendor/phpunit/phpunit/src/Framework/Constraint/IsFinite.php");
