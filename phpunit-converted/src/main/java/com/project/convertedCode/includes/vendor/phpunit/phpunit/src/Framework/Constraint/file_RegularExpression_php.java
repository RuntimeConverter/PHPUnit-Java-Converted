...
public class file_RegularExpression_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope435 scope = new Scope435();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope435 scope)
    ...
    private static class Scope435 implements UpdateRuntimeScopeInterface {
