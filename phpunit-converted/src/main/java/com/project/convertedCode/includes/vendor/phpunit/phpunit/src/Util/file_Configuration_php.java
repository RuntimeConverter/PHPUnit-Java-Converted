...
public class file_Configuration_php implements RuntimeIncludable {
    ...
    public final void include(RuntimeEnv env, RuntimeStack stack) throws IncludeEventException {
        Scope505 scope = new Scope505();
        stack.pushScope(scope);
        this.include(env, stack, scope);
        stack.popScope();
    }

    public final void include(RuntimeEnv env, RuntimeStack stack, Scope505 scope)
    ...
    private static class Scope505 implements UpdateRuntimeScopeInterface {
